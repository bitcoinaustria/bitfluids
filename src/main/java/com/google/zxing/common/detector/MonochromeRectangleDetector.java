...
public final class MonochromeRectangleDetector {
   ...
   *         are the second and third. The first point will be the topmost point
   *         and the last, the bottommost. The second point will be leftmost and
  ...
  private ResultPoint findCornerFromCenter(int centerX, int deltaX, int left, int right, int centerY, int deltaY,
      int top, int bottom, int maxWhiteRun) throws NotFoundException {
    int[] lastRange = null;
   ...
   *          location) where we are scanning. If scanning vertically it's the
   *          column, the fixed horizontal location
   * @param maxWhiteRun
   *          largest run of white pixels that can still be considered part of
   *          the barcode region
   * @param minDim
