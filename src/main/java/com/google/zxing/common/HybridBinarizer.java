...
public final class HybridBinarizer extends GlobalHistogramBinarizer {
  ...
  // previous block).
  private static void calculateThresholdForBlock(byte[] luminances, int subWidth, int subHeight, int width, int height,
  ...
  private static void threshold8x8Block(byte[] luminances, int xoffset, int yoffset, int threshold, int stride,
      BitMatrix matrix) {
    for (int y = 0; y < 8; y++) {
