...
public final class BitArray {
   ...
   * @param value
   *          if true, checks that bits in range are set, otherwise checks that
   *          they are not set
   ...
   *          first. This is the opposite of the internal representation, which
   *          is exposed by {@link #getBitArray()}
   * @param offset
