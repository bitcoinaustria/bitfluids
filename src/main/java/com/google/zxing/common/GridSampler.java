...
public abstract class GridSampler {
   ...
   * 
   * <p>
   * This method will actually "nudge" the endpoints back onto the image if they
   * are found to be barely (less than 1 pixel) off the image. This accounts for
   * imperfect detection of finder patterns in an image where the QR Code runs
