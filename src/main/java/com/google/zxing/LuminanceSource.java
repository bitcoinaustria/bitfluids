...
public abstract class LuminanceSource {
   ...
   *          ignored. Always use the returned object, and ignore the .length of
   *          the array.
   ...
   * using: int luminance = array[y * width + x] & 0xff;
   * 
   * @return A row-major 2D array of luminance values. Do not use result.length
   *         as it may be larger than width * height bytes on some platforms. Do
   *         not modify the contents of the result.
   */
