...
public final class ResultMetadataType {
   ...
   * makes available the complete raw bytes in the barcode for these formats, it
   * does not offer the bytes from the byte segments alone.
   * </p>
   * 
   * <p>
  ...
  /**
   * For some products, the possible country of manufacture as a {@link String}
   * denoting the ISO country code. Some map to multiple possible countries,
   * like "US/CA".
   */
