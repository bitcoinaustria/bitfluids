...
final class MultiFinderPatternFinder extends FinderPatternFinder {
   ...
   *         "best" are those that have been detected at least
  ...
  private FinderPattern[][] selectBestPatterns() throws NotFoundException {
     ...
     */
    if (size == 3) {
      return new FinderPattern[][] { new FinderPattern[] { (FinderPattern) possibleCenters.elementAt(0),
          (FinderPattern) possibleCenters.elementAt(1), (FinderPattern) possibleCenters.elementAt(2) } };
    }
     ...
     * module count is within the QR specification - have similar distance
     * between upper left/right and left top/bottom finder patterns - form a
     * triangle with 90° angle (checked by comparing top right/bottom left
     * distance with pythagoras)
     * 
     * Note: we allow each point to be used for more than one code region: this
     * might seem counterintuitive at first, but the performance penalty is not
     * that big. At this point, we cannot make a good quality decision whether
