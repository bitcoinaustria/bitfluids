...
public class FinderPatternFinder {
  ...
  protected static final int        MIN_SKIP           = 3; // 1 pixel/module
                                                             // times 3
  // modules/center
  protected static final int        MAX_MODULES        = 57; // support up to
                                                             // version 10 for
  // mobile clients
   ...
   * @param maxCount
   *          maximum reasonable number of modules that should be observed in
   ...
   * the number of times each location has been nearly-matched as a finder
   * pattern. Each additional find is more evidence that the location is in fact
   * a finder pattern center
   * 
   * @param stateCount
  ...
  private FinderPattern[] selectBestPatterns() throws NotFoundException {
    ...
    return new FinderPattern[] { (FinderPattern) possibleCenters.elementAt(0),
