...
abstract class DataMask {
  ...
  /**
   * <p>
   * Implementations of this method reverse the data masking process applied to
   * a QR Code and make its bits ready to read.
   * </p>
   * 
   * @param bits
  ...
  /**
   * @param reference
   *          a value between 0 and 7 indicating one of the eight possible data
   *          mask patterns a QR Code may use
